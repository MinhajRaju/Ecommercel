                                    ...
                                    if (data.parent == null) {
                                        ...
                                        return (
                                            <div class="col" > <a href="shop-grid.html" class="text-decoration-none text-inherit">
                                                ...
                                                <div class="card card-product" style={{ borderRadius: "3pc", background: "#0aad0a" }}>
                                                    <div class="card-body text-center py-8"  >


                                                        <div class="text-truncate" style={{ textTransform: "capitalize", color: "white" }}>{data.name}</div>
                                                    </div>
                                                </div>
                                            </a></div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="row row-cols-xl-6 row-cols-lg-3 g-2">
                                                <ProductCard data={this.props.FlashSaleData} />
                                            </div>
