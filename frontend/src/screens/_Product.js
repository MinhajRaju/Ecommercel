                                    ...
                                    <div class="col-md-4">
                                        <div class="ps-lg-10 mt-6 mt-md-0">
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <div >
                                                    {this.state.variationthumb == undefined ? null : this.state.variationthumb.map((data) => {
                                                        return (
                                                            <>

                                                                <img onMouseOver={this.productimage} width="20%" height="30%" src={`../assets/static${data.photo}`} />&nbsp;
                                                            </>
                                                        )
                                                    })}
